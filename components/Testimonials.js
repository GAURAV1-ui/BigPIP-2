          ...
          <div className={styles.testimonials_content}>
            <div className={styles.testimonials_content_heading}>
              ...
              <div className={styles.testimonials_content_heading_p}>
                Our 24/7 support team is available for all your FOREX Funded
                account needs, day or night we are there for you. When you need
                us we are always there to assist.
              </div>
            </div>
          </div>
          <div className={styles.testimonials_content}>
            <div className={styles.testimonials_content_cards}>
              {testimonial.map((item, i) => (
                <div key={i} className={styles.testimonials_content_card}>
                  ...
                  <FaStar /> */}
                      ...
                      {Array.from(
                        { length: item.attributes.clientRating },
                        (_, index) => (
                          <FaStar key={index} />
                        )
                      )}
                      <span
                        className={
                          styles.testimonials_content_card_heading_star
                        }
                      >
